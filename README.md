...
```tsv
sample	library	flowlane	fq1	fq2	platform	trim_front1	trim_front2	trim_tail1	trim_tail2	pcr_based
SAMPLE1	LIB1	LANE1	/path/to/SAMPLE1_R1.fastq.gz	/path/to/SAMPLE1_R2.fastq.gz	ILLUMINA	0	0	0	0	No
SAMPLE2	LIB2	LANE2	/path/to/SAMPLE2_R1.fastq.gz	/path/to/SAMPLE2_R2.fastq.gz	ILLUMINA	5	5	0	0	Yes
```
